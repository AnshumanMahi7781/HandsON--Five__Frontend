...
function App() {
  const APIurl = "https://handsonfivebackend.onrender.com/"
  ...
  const handleSendMessageClick = (e) => {
    e.preventDefault();
    // let temp = {
    //   sendingMessage: userMessageRef.current.value,
    // }
    console.log("CLICK")
  ...
  useEffect(() => {
    ...
    socketClient.on("receivingMessage", res => {
      console.log(res)
    })
...

      {
        !isVisible && <div className="roomJoiningContainer">
          ...
          <div className="roomJoiningContainer__formBox">
            ...
            <input type="text" id="roomID" name="roomName" placeholder="Enter Your Room Name Or ID" className="roomJoiningContainer_inutField" ref={roomNameRef} />

          </div>

          <div className="roomJoiningContainer__formBox">
            <input type="text" id="userName" name="userName" placeholder="Your  Name" className="roomJoiningContainer_inutField" ref={userNameRef} />
          </div>
